...
# battery.life.main <- read.csv("RawData/Battery Life.")
...
```{r}
ownership.durations <- c("Less than 3 months", "Between 3 - 6 months", "Between 7 – 12 months","More than 12 months", "Not available")
...
ggplot(merged.working)+geom_point(aes(x = PIS, y = pNPS))+xlab("PIS")+ggtitle("Average pNPS over all Surveys")+ ylab("pNPS")+facet_grid(.~ownership.duration,scales = "free")
```
...
- Majority of the observations are from witin three months of ownership.
- Of the 
