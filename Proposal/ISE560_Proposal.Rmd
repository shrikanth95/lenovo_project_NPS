...
\begin{enumerate}[nosep]
  ...
  \item The output from the MDP will be a recommended action based on the transition matrix, rewards, etc.
\end{enumerate}
...
The states that can be used to develop a Markov Chain include NPS states and star rating states. We have categorized NPS into five states. 
...
```{r fig.cap="\\label{fig:fig_comm}Commercial Sentiment and NPS Data", fig.pos="H"}
####################################################
...
References: https://www.satmetrix.com/wp-content/uploads/2019/04/2019-Benchmarks.pdf
