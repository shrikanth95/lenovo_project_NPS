...
We propose developing a linear regression model where Product Sentiment Index (PSI) is one of the explanatory variables, and PSI will be modeled as a stochastic process.  Based on a preliminary analysis of the data (see Section \ref{data_analysis}), star rating, product series and telemetry data are potential explanatory variables.   

## Metrics

We propose using k-fold cross validation to evaluate candidate models:
