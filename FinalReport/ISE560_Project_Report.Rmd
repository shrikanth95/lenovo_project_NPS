...
## Category-wise Correlation Between NPS and PSI 

```{r eval=TRUE, fig.cap = "\\label{fig:neg-corr} Correlation between NPS and PSI for Customer Series", fig.width = 8}
...
## Relevant categories that that positively correlate with NPS scores
...
## Categories for Potential Improvement
