...
knitr::kable(round(P1, digits=3), row.names=TRUE, caption = "Consumer, All States, Action = Do Nothing  \\label{tbl:P1}", booktabs = T)%>%kable_styling(font_size = 9)
...
knitr::kable(round(P2[c(1,2,6,7),], digits=3), row.names=TRUE,
             caption = "Consumer, All States, Action = Root Cause Analysis \\label{tbl:P2}", booktabs = T) %>% kable_styling(font_size = 9)
...
knitr::kable(series.ts.main.com[series.ts.main.com$Duration == 7,-5],row.names = FALSE,caption = "\\label{tab:ARIMA_Commercial} Series wise Consumer Survey", col.names = c("Series", "Order", "MAE", "RMSE"), booktabs = T)
knitr::kable(series.ts.main[series.ts.main$Duration == 7,-5],row.names = FALSE,caption = "\\label{tab:ARIMA_Consumer} Series wise Consumer Survey", col.names = c("Series", "Order", "MAE", "RMSE"), booktabs = T)
...
knitr::kable(data.frame(nconsumer, unname(beta_coeff)),
             ...
             caption = "Coefficients for Consumer Model", booktabs = T) 
...
knitr::kable(data.frame(ncomm, unname(beta_coeff1), unname(beta_coeff2)), 
             ...
             caption = "Coefficients for Commercial Model", booktabs = T) 
...
knitr::kable(ideapad330.summ, caption="Ideapad 330 Predictions, 95% Confidence and Prediction Intervals", booktabs = T)
```
...
knitr::kable(yoga730.summ, caption="Yoga 730 Predictions, 95% Confidence and Prediction Intervals", booktabs = T)
```
...
knitr::kable(legiony730.summ, caption="Legion Y730 Predictions, 95% Confidence and Prediction Intervals", booktabs = T)
...
knitr::kable(t490.summ, caption="T490 Predictions, 95% Confidence and Prediction Intervals", booktabs = T)
...
knitr::kable(R_A1, row.names=TRUE, caption = "Consumer, Rewards, Action = Do Nothing", booktabs = T)
```
...
knitr::kable(R_A2[c(1,2,6,7),], row.names=TRUE, caption = "Consumer, Rewards, Action = Root Cause Analysis", booktabs = T)
...
knitr::kable(p.tel ,  caption = "A possible telemetry transtion matrix from ",  row.names = TRUE, booktabs = T)
