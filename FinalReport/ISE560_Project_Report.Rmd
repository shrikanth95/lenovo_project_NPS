...
NPS values are charasterized based on the industry considerations given in Section \ref{sec:statedef} five 20\% quantiles denoted as $S_S \in \{++,+, 0, -, - -\}$)  and is referred to as $P_{S}$ 
